      ...
      <aside id="sidebar"
        ...
        <div class="h-full flex flex-col">
          ...
          <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            <a href="{{ route('super_admin.aircrafts.aircrafts') }}" class="group flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-slate-700/50 text-slate-300 hover:text-white transition-all duration-200">
              <div class="flex items-center justify-center h-8 w-8 rounded-lg bg-slate-700/50 group-hover:bg-slate-600 transition-colors">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
