            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}"
                        placeholder="Enter city name (e.g., Colombo, Kandy)" required @class([
                            'w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors',
                            'border border-slate-300' => !$errors->has('name'),
                            'border border-red-300' => $errors->has('name'),
                        ])>
                ...
                <div>
                    ...
                    <select name="status" id="status" @class([
                        ...
                        'border border-red-300' => $errors->has('status'),
                    ])>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        placeholder="Brief description about helicopter rides available in this city..." @class([
                            'w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors',
                            'border border-slate-300' => !$errors->has('description'),
                            'border border-red-300' => $errors->has('description'),
            ...
            <div class="flex items-center justify-between">
                ...
                @if ($cities->count() > 0)
                    <div class="text-sm text-slate-600">
                        <span
                            class="inline-flex items-center px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-medium mr-2">
                            {{ $cities->where('status', 'active')->count() }} Active
                        </span>
                        <span
                            class="inline-flex items-center px-2 py-1 bg-red-100 text-red-800 rounded-full text-xs font-medium">
        ...
        @else
            ...
            <div class="px-6 py-12 text-center">
                <div class="max-w-md mx-auto">
                    ...
                    <p class="text-slate-600 mb-4">Add your first city using the form above to start managing available
                        ride locations.</p>
                </div>
            </div>
        @endif
