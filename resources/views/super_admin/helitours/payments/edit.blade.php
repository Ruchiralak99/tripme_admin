...
@section('content')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
           ...
           {{ $errors->has('payment_method') ? 'border-red-500' : 'border-gray-300' }}">
                            ...
                            <div>
                                ...
                                <select name="payment_type" id="payment_type" required
                                    class="w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500
           {{ $errors->has('payment_type') ? 'border-red-500' : 'border-gray-300' }}">
                                    <option value="">Select Payment Type</option>
                                    <option value="full"
                                        {{ old('payment_type', $payment->payment_type) == 'full' ? 'selected' : '' }}>
                                        Full Payment
                                    </option>
                                    <option value="partial"
                                        {{ old('payment_type', $payment->payment_type) == 'partial' ? 'selected' : '' }}>
                                        Partial Payment
                                    </option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="reference_number" id="reference_number"
                                    value="{{ old('reference_number', $payment->reference_number) }}" maxlength="255"
                                    placeholder="Enter transaction reference number"
                                    class="w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500
           {{ $errors->has('reference_number') ? 'border-red-500' : 'border-gray-300' }}">
                            ...
                            <div>
                                ...
                                <select name="promo_code_id" id="promo_code_id"
                                    class="w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500
           {{ $errors->has('promo_code_id') ? 'border-red-500' : 'border-gray-300' }}">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="admin_notes" id="admin_notes" rows="4"
                                placeholder="Add any administrative notes about this payment..."
                                class="w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500
           {{ $errors->has('admin_notes') ? 'border-red-500' : 'border-gray-300' }}">{{ old('admin_notes', $payment->admin_notes) }}</textarea>
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <span @class([
                                ...
                                'bg-gray-100 text-gray-800' => !in_array($payment->status, [
                                    'verified',
                                    'pending',
                                    'rejected',
                                ]),
                        ...
                        @if ($payment->verified_at)
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900">{{ $payment->verified_at->format('M d, Y h:i A') }}
                                </p>
                            </div>
                        @endif
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900 font-mono">{{ $payment->booking->booking_reference }}
                                </p>
                            </div>
                ...
                @if ($payment->payment_slip_path)
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('storage/' . $payment->payment_slip_path) }}" alt="Payment Slip"
                                class="w-full rounded-lg shadow-md mb-4">

                            <a href="{{ asset('storage/' . $payment->payment_slip_path) }}" target="_blank"
